...
export function startSync(){
  ...
  F.onSnapshot(F.doc(F.fs,"app","config"), snap=>{
    if(!snap.exists()){
      /* АНХААР: persistentLocalCache-тэй үед энэ снапшот эхлээд утасны
         дотоод IndexedDB кэшээс ирдэг. Тэр кэш хоосон бол (шинэ төхөөрөмж,
         хөтчийн санах ой цэвэрлэгдсэн г.м) сервер дээр бодит өгөгдөл
         байсан ч энд "олдсонгүй" гэж харагдана. Үүнийг үнэхээр шинэ
         суулгац гэж андуураад push хийвэл бодит мэдээллийг дарж устгана —
         яг энэ алдаанаас болж бүх өгөгдөл анхны хувилбар руу буцсан.
         Тиймээс зөвхөн серверээс өөрөөс нь "байхгүй" гэдэг нь
         баталгаажсан үед (fromCache биш үед) л шинэ суулгац гэж үзнэ. */
